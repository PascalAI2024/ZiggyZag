...
Start at [README.md](README.md) for the documentation hub. Use [RESEARCH.md](RESEARCH.md) for source-backed product signals and [DATA_MAP.md](DATA_MAP.md) for QA/release evidence flow.
