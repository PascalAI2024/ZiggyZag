...
A practical orientation for new contributors. Read [architecture.md](../reference/architecture.md) for the high-level design picture; this guide focuses on where the code lives and how to move through it quickly.
...
See [release-checklist.md](release-checklist.md) for the release-artifact build and QA steps.
