...
The daily-driver terminal backlog now lives in [next-20-features.md](next-20-features.md). That list is the current execution order for the Ghostty/WezTerm-inspired terminal, shell, settings, and agent work. The alpha remaining-work source of truth is [alpha-tasks.md](alpha-tasks.md), and official source traceability lives in [research.md](research.md).
...
5. Hardening the new desktop AgentD side panel with richer tool browsing, audit export, and provider streaming; see [apps/agentd](../../apps/agentd/README.md) and [terminal-app.md](../reference/terminal-app.md).
