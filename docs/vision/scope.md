...
For the full docs map, start at [README.md](../README.md). For alpha remaining work, use [alpha-tasks.md](alpha-tasks.md); for task flow, use [task-system.md](../reference/task-system.md); for research traceability, use [research.md](research.md).
...
The next major scope decision is the all-Zig desktop stack: windowing/rendering layer, PTY abstraction, and whether to use `libghostty-vt` immediately or after a small local ANSI parser proves the host boundary. The active strategy docs are [all-zig-terminal.md](../reference/all-zig-terminal.md) and [terminal-app.md](../reference/terminal-app.md).
